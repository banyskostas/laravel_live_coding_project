...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>talech confidential</title>
...
| There is no need to create any files cause they are already created for you.
| 
| Requirements:
| - Analyze products migration file and write the needed code.
| - List of products should be grouped and sorted by it's creation time
